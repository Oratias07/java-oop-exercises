...
// Minimal replacement for util.Tester to allow tests to run without external dependency
class Tester {
	void initStructureTest() {}
	void initPublishedTest(Class<?> c) {}
	void testEqualClasses(Class<?> a, Class<?> b) {}
	void checkEq(Object a, Object b) {
		if (a == null ? b != null : !a.equals(b))
			System.out.println("FAIL: expected='" + b + "' got='" + a + "'");
	}
	void checkEq(Object a, Object b, String msg) {
		if (a == null ? b != null : !a.equals(b))
			System.out.println("FAIL " + msg + ": expected='" + b + "' got='" + a + "'");
	}
	public void myMain(String args) { /* default: do nothing */ }
}
